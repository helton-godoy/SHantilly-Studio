...
bool StudioController::eventFilter(QObject* watched, QEvent* event) {
    if (event->type() == QEvent::MouseButtonPress) {
        ...
        if (widget) {
            ...
            if (objName.startsWith("qt_") || className.contains("TabBar") ||
                className.contains("ScrollBar") || className.contains("StackedWidget") ||
                className.contains("SpinBox") || className.contains("ComboBox") ||
                className.contains("LineEdit") || className.contains("Calendar") ||
                className.contains("ItemView") || className.contains("ListView") ||
                className.contains("TableView") || className.contains("TreeView") ||
                className.contains("HeaderView") || className.contains("Menu") ||
                className.contains("ToolButton") || className.contains("AbstractButton")) {
